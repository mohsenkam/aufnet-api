...
namespace Aufnet.Backend.Services.Customers
{
    public class CustomerProfilesService : ICustomerProfileService
    {
        ...
        //        return getResult;
        //    }
        //    var profile = _context.CustomerProfiles.FirstOrDefaultAsync(cp => cp.UserName.Equals(username));
        ...
        //public async Task<IServiceResult> CreateProfileAsync(string username, CustomerProfileDto value)
        //{
        //    var serviceResult = new ServiceResult();
        //    try
        //    {
        ...
        //public async Task<IServiceResult> UpdateProfileAsync(string username, CustomerProfileDto value)
        //{
        //    var serviceResult = new ServiceResult();
        //    try
        //    {
        ...
        //public async Task<IServiceResult> DeleteProfileAsync(string username)
        //{
        //    var serviceResult = new ServiceResult();
        //    try
        //    {
        ...
        //}
        public Task<IGetServiceResult<CustomerProfileDto>> GetProfileAsync(string username)
        {
            throw new NotImplementedException();
        }

        public Task<IServiceResult> CreateProfileAsync(string username, CustomerProfileDto value)
        {
            throw new NotImplementedException();
        }

        public Task<IServiceResult> UpdateProfileAsync(string username, CustomerProfileDto value)
        {
            throw new NotImplementedException();
        }

        public Task<IServiceResult> DeleteProfileAsync(string username)
        {
            throw new NotImplementedException();
        }
    }
